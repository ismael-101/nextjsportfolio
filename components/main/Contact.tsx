      ...
      >
        ...
        >
          <form
            ...
            className="bg-white flex lg:flex-row flex-col rounded-lg w-3/4 lg:h-3/4 h-[100%] lg:relative max-lg:static top-0 "
          >
            <div className="text-gray-700 p-6 max-lg:mt-20 lg:p-14  lg:px-10 z-10 w-full ">
              ...
              <div className="mt-6 lg:flex lg:gap-5">
                ...
                <div className="lg:flex-1 ">
                  ...
                  <button
                    type="submit"
                    className="btn btn-graborder-neutral-content btn-wide text-graborder-neutral-content-content  "
                  >
                    send
                  </button>
                </div>
        ...
        <>
          {/*Footer container*/}
          <footer className="flex w-full flex-col items-center bg-zinc-50 text-center text-surface dark:bg-neutral-700 dark:text-white static bottom-0">
