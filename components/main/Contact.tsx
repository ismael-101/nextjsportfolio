...
export default function Contact() {
  return (
    <AnimatePresence>
      ...
      >
        <div className="">
          <h1 className="text-5xl font-bold m-5">you can reach me here:</h1>
          <div className="flex items-center gap-10">
            <Image src={email} alt="email" width={100} height={200} />
            <p className="text-4xl font-bold">ismaelwork0@gmail.com</p>
          </div>
          <div className="flex items-center  gap-10">
            <Image src={phone} alt="email" width={100} height={200} />
            <p className="text-4xl font-bold">+491771584936</p>
          </div>
        </div>
      </motion.div>
    </AnimatePresence>
